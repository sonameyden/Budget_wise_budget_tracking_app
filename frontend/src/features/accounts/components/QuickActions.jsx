...
import { Plus, Target, BarChart2, CreditCard } from 'lucide-react';
import { motion } from 'framer-motion';

const ACTIONS = [
  { label: 'Add Transaction', Icon: Plus,       color: 'bg-emerald-500', to: '/transactions' },
  { label: 'Add Account',     Icon: CreditCard, color: 'bg-blue-500',    to: '/accounts'     },
  { label: 'Add Goal',        Icon: Target,     color: 'bg-violet-500',  to: '/goals'        },
  { label: 'Analytics',       Icon: BarChart2,  color: 'bg-amber-500',   to: '/analytics'    },
];
